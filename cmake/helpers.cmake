...
function(package_add_boost)
    ...
    find_package(Boost COMPONENTS system program_options exception locale thread unit_test_framework CONFIG REQUIRED)
    foreach (arg ${ARGV})
        target_link_libraries(${arg} PUBLIC ${Boost_LIBRARIES} Boost::unit_test_framework Threads::Threads ${Iconv_LIBRARIES} ${ICU_LIBRARIES})
